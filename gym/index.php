...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/gym/head.css"> 
  <style type="text/css">
    .background{
      position: fixed;
      z-index: -1000;
...
<div class="container-fluid">
  <a class="navbar-brand" href="index.php"><h3 class="heading">GYM MANAGEMENT SYSTEM</h3></a>
...
<div class="background">
  <img src="http://localhost/gym/gym_g.jpeg">
</div>
